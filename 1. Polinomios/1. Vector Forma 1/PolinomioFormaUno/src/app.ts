import { PolinomioFormaUno } from "./PolinomioFormaUno";

//1. Mostrando los elementos que están en el polinomio A de grado 8
let polinomioUno = new PolinomioFormaUno('A', [4,3,2,1,3,8])
...
let polinomioDos = new PolinomioFormaUno('B', [5,3,2,0,3,0,4])
